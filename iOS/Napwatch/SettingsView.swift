        ...
        NavigationStack {
            List {
                ...
                Section("Subscription") {
                    if purchases.isPro {
                        Label("Napwatch Pro active", systemImage: "checkmark.seal.fill")
                ...
                Section("About") {
                    Link("Privacy Policy", destination: URL(string: "https://shimondeitel.github.io/napwatch-app/privacy.html")!)
                    Link("Terms of Use", destination: URL(string: "https://shimondeitel.github.io/napwatch-app/terms.html")!)
                    Text("Version 1.0")
                        .foregroundStyle(Theme.textMuted)
                }
            }
